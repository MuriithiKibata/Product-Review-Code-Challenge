...
Review.create(star_rating: 6, comment: "Decent", user_id: user2.id, product_id: product1.id)
...
Review.create(star_rating: 10, comment: "Too Good!", user_id: user1.id, product_id: product5.id)
# *****************************************************************
